...
RUN --mount=type=cache,id=s/07e3337c-45d6-41c2-b382-b1d0a2079397-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store \
...
RUN --mount=type=cache,id=s/07e3337c-45d6-41c2-b382-b1d0a2079397-/var/cache/apt,target=/var/cache/apt \
    --mount=type=cache,id=s/07e3337c-45d6-41c2-b382-b1d0a2079397-/var/lib/apt,target=/var/lib/apt \
    apt-get update && \
