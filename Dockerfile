...
RUN --mount=type=cache,id=s/71c5391f-b977-4ddc-b284-22684a9971c7-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store \
...
RUN --mount=type=cache,id=s/71c5391f-b977-4ddc-b284-22684a9971c7-/var/cache/apt,target=/var/cache/apt \
    --mount=type=cache,id=s/71c5391f-b977-4ddc-b284-22684a9971c7-/var/lib/apt,target=/var/lib/apt \
    apt-get update && \
